...
void test_selection_sort_random(void) {
    printf("\n\033[1;36m=== Testing Selection Sort with Random Array ===\033[0m\n");
    ...
    print_array(arr, size < 20 ? size : 20, "After sorting (first 20 elements)");
...
void test_selection_sort_reverse(void) {
    printf("\n\033[1;35m=== Testing Selection Sort with Reverse Sorted Array ===\033[0m\n");
